 ...
 * Created for the project cologger with the name AlgorithmicParams
 */

public class AlgorithmicParams {

    public AlgorithmicParams(String name, int hashSize, long poly, long init, boolean refIn, boolean refOut, long xorOut, long check) {
        Name = name;
        Check = check;
        Init = init;
        Poly = poly;
